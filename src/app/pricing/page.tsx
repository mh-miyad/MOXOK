...
const Pricing = () => {
  ...
  return (
    <>
      <MaxWidthWrapper>
          <div className=' mb-8 mt-24 text-center max-w-5xl text-black '>
        
        <div>
          <div className='mx-auto mb-10 sm:max-w-lg'>
          <h1 className='text-6xl font-bold sm:text-7xl text-transparent bg-clip-text bg-gradient-to-r from-gray-300 capitalize to-slate-600 drop-shadow-xl  p-4'>
            Pricing
          </h1>
                ...
                return (
                  <div
                    ...
                    className={`
                        ...
                        ${plan === 'Pro' ? 'border-2 border-blue-600 shadow-blue-200' : 'border border-gray-200'}
                      `}>
                    {plan === 'Pro' && (
